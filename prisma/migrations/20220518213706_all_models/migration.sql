...
-- AddForeignKey
ALTER TABLE `CategoriesOnArticle` ADD CONSTRAINT `CategoriesOnArticle_categoryId_fkey` FOREIGN KEY (`categoryId`) REFERENCES `Category`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
